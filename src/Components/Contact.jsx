...
function Contact() {
  ...
  const [state, handleSubmit] = useForm("mwkdbgzb");
  if (state.succeeded) {
      ...
      <Flex w={"100%"}  className="contact-section">
        <Box className="contact-icons">
          ...
          <Box>
            ...
            />
            <b>Ahemdabad, Gujrat</b>
          </Box>

          <Box>
            <a href="tel:+918469558076">
              <IconButton
                variant="outline"
                colorScheme="orange"
                aria-label="Send email"
        ...
        <Box className="contact-form">
          ...
          <form action="https://formspree.io/f/mwkdbgzb"  onSubmit={handleSubmit} method="POST"  >
          <FormControl>
